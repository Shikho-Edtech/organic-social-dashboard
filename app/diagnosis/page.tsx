    ...
    <div className={isArchival ? "opacity-[0.97] [filter:saturate(0.9)]" : ""}>
      ...
      {isArchival ? (
        ...
        <StalenessBanner
          ...
          artifact="diagnosis"
          runStatus={runStatus}
          // 2026-05-04: only flag aiDisabled on the THIS WEEK view. Past-week
          // views (?week=last) show data that WAS generated by a prior AI
          // run, so labeling them "AI off this run" is misleading — the
          // user explicitly asked for past data, the latest run's engine
          // state isn't relevant to the content shown.
          aiDisabled={aiDisabled && isThisWeekView}
          hasData={!!diagnosis}
        />
      )}
      <AcademicContextStrip />
