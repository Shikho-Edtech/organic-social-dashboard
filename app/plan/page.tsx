...
export default async function PlanPage() {
  ...
  return (
    <div>
      <StalenessBanner info={staleness} artifact="calendar" />
      <PageHeader title="Plan" subtitle="Next week's content calendar — click a day to expand" dateLabel="Generated by latest weekly run" showPicker={false} />
