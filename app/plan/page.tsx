    ...
    <div className={isArchival ? "opacity-[0.97] [filter:saturate(0.9)]" : ""}>
      ...
      {!isArchival && (
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-4">
          ...
          />
          {/* Sprint P7 v4 (2026-04-29): regenerate button on running-
              week views (This + Next). Locking applies to those
              writers; Last week is historical and shouldn't be
              regenerated by design. */}
          {(isThisWeekView || isNextWeekView) && (
            <RegenerateThisWeekButton scope="weekly" />
          )}
        </div>
      )}
