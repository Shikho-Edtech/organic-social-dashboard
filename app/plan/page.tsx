...
import { getCalendar, getRunStatus, computeStaleness } from "@/lib/sheets";
...
export default async function PlanPage() {
  ...
  return (
    <div>
      <StalenessBanner info={staleness} artifact="calendar" hasData={calendar.length > 0} />
      <PageHeader title="Plan" subtitle="Next week's content calendar — click a day to expand" dateLabel="Generated by latest weekly run" showPicker={false} lastScrapedAt={runStatus.last_run_at} />
